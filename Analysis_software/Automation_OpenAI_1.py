...
folder_path = r"C:\Users\kamalesh.kb\Automation_Issues\CodeForAutomation_OpenAI"
    ...
    if fault_name == 'Controller_Undervoltage_408094978':
        ...
        if voltage_at_error < undervoltage_threshold:
            analyzed_statements.append({
                "role": "system",
                "content": f"The maximum battery voltage ({max_battery_voltage}V) is below the undervoltage threshold."
            })
